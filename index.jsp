                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-12">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay="0.2s">Online<br>Learning Management System</h1>
                                    <p data-animation="fadeInLeft" data-delay="0.4s">Teaching tool to assist each and every CUTMAP student to learn in an interactive manner.</p>
                                </div>
                            </div>
                        </div>
                    </div>
