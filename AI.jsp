...
<head>
    ...
    <title>Artificial Intelligence Playlist by SimpliLearn</title>
    <style>
        .section .h1 {
	text-align: center;
	margin-top: 5rem;
...
<body>
    <section>
        <h1>Artificial Intelligence tutorial by SimpliLearn</h1>
        <h2 class="title"></h2>
        <div class="container">
            <div id="video_player">
 ...
 // Ensure allVideos is defined and not empty
    let allVideos = [
       {
          name: "what is AI",
          src: "https://www.youtube.com/embed/ad79nYk2keg?si=bmp9judCxLx-oCvu&amp;start=3355" ,
            id: "vid_3"
        },
        {
            name: "AI full course",
            src:"https://www.youtube.com/embed/8Pyy2d3SZuM?si=4pApw9XXnt65m8kW" ,
            id: "vid_4"
         },
       
         {
            name: "AI for begginers",
            src: "https://www.youtube.com/embed/sp_OMFCfGMw?si=JixCWTZkfnN0Zz5B"  ,
            id: "vid_6"
         },
         {
            name: "Deep  Learning",
            src:"https://www.youtube.com/embed/anTjbDH6y-Y?si=_OBJcJaQu6aHGNCR"  ,
            id: "vid_7"
         },
         {
            name: "Future of AI ",
            src: "https://www.youtube.com/embed/bZP4VXpCk6A?si=rzYUjYsITqW9lock" ,
            id: "vid_8"
         },
         {
            name: "AI in 6 minutes",
            src: "https://www.youtube.com/embed/uh5LCXOBmSI?si=X22pOdelo3N08-Cg",
            id: "vid_9"
         },
         {
            name: "types of AI",
            src: "https://www.youtube.com/embed/15PK38MUEPM?si=rbBsx4QnYME9ttn9",
            id: "vid_10"
         },
         {
            name: "AI",
            src: "https://www.youtube.com/embed/FWOZmmIUqHg?si=rHUoYTd7C6bD7G2W" ,
            id: "vid_11"
         },
         {
            name: "AI Application",
            src: "https://www.youtube.com/embed/VNz3KGoAhG4?si=CM-Nfutepm9RQNJK",
            id: "vid_12"
         },
         {
             name: "Neural network",
             src: "https://www.youtube.com/embed/bfmFfD2RIcg?si=ocLyilywgidyB88K",
             id: "vid_12"
          },
          {
              name: "K means clustering",
              src: "https://www.youtube.com/embed/Xvwt7y2jf5E?si=GmZv5lX3ceDeRJsa",
              id: "vid_12"
           },
