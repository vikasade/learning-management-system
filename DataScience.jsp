...
<head>
    ...
    <title>DataScience Playlist by freecodecamp</title>
    <style>
        .section .h1 {
	text-align: center;
	margin-top: 5rem;
...
<body>
    <section>
        <h1>DataScience tutorial by freecodecamp</h1>
        <h2 class="title"></h2>
        <div class="container">
            <div id="video_player">
    ...
    let allVideos = [
       {
          ...
          src:"https://www.youtube.com/embed/ua-CiDNNj30?si=_tNc-JeO-yYEfScG", 
            id: "vid_3"
        },
        {
            name: "Statistic Course",
            src:"https://www.youtube.com/embed/xxpc-HPKN28?si=F4VVH_Gd9R2160ZU" ,
            id: "vid_4"
         },
       
         {
            name: "Python for DataScience",
            src:"https://www.youtube.com/embed/LHBE6Q9XlzI?si=OnBsk00Rvs7Ij0Yg",
            id: "vid_6"
         },
         {
            name: "DataAnalysis",
            src: "https://www.youtube.com/embed/GPVsHOlRBBI?si=l9BQcFKE4L5baJW-",
            id: "vid_7"
         },
         {
             name: "DataScience App",
             src:"https://www.youtube.com/embed/r-uOLxNrNk8?si=FtqkL4MtZZLhAAKB", 
               id: "vid_3"
           },
           {
               name: "Regularization",
               src:"https://www.youtube.com/embed/JwSS70SZdyM?si=hMpyMZOwCQQ_ckhx" ,
               id: "vid_4"
            },
          
            {
               name: "Hands on experience",
               src:"https://www.youtube.com/embed/XU5pw3QRYjQ?si=r1tQZddG0GQKzbzc",
               id: "vid_6"
            },
            {
               name: "Data visualization",
               src: "https://www.youtube.com/embed/_8V5o2UHG0E?si=Ue6cp_JdsoBULO1x",
               id: "vid_7"
            },
            {
                name: "R programming tutorial",
                src: "https://www.youtube.com/embed/_V8eKsto3Ug?si=WvAqkf4Y_sSjLkjL",
                id: "vid_7"
             },
             {
                 name: "Python for bioinformatics",
                 src: "https://www.youtube.com/embed/jBlTQjcKuaY?si=n31AM6p386C1EXtT",
                 id: "vid_7"
              },
