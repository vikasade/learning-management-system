...
<head>
    ...
    <title>Forensic Playlist by Forensic Science by Priyanshi </title>
    <style>
        .section .h1 {
	text-align: center;
	margin-top: 5rem;
...
<body>
    <section>
        <h1>Forensic tutorial by Forensic Science by Priyanshi </h1>
        <h2 class="title"></h2>
        <div class="container">
            <div id="video_player">
 ...
 // Ensure allVideos is defined and not empty
    let allVideos = [
       {
          name: "History Of Forensic",
          src:"https://www.youtube.com/embed/95MIlZNrkjo?si=bGQE80Bw_LdDDm0a" , 
            id: "vid_3"
        },
        {
            name: "History Of Forensic part2",
            src:"https://www.youtube.com/embed/NuYV9hVe2Ps?si=z6ypuaaM0S40MDPE"  ,
            id: "vid_4"
         },
       
         {
            name: "History Of Forensic parts",
            src:"https://www.youtube.com/embed/OibpHLdAn0o?si=S8rgTEsbUiyg0G9O",
            id: "vid_6"
         },
         {
            name: "Basics principles",
            src: "https://www.youtube.com/embed/4hab4XZ00QE?si=zDn79RA91hGTaPLu",
            id: "vid_7"
         },
         {
             name: "Forensic Organization",
             src:"https://www.youtube.com/embed/NKXtw2e2LuI?si=UrAqzZehysK8QdMX" , 
               id: "vid_3"
           },
           {
               name: "Crime Scene and its Type",
               src:"https://www.youtube.com/embed/NpT3N8O4xjQ?si=fwGU0awQ2FHtiJfC" ,
               id: "vid_4"
            },
          
            {
               name: "Components Of Crime",
               src:"https://www.youtube.com/embed/Z7G_P7NNIg0?si=YVOcrRMONN9gfZlq",
               id: "vid_6"
            },
            {
               name: "Crime Scene Investigation",
               src: "https://www.youtube.com/embed/rdn8KEuJfvM?si=JDvcPyFMrP5i-LFH",
               id: "vid_7"
            },
            {
                name: "Crime Scene Sketching Methods",
                src: "https://www.youtube.com/embed/6cj4cTjHMoE?si=oLF9UbDc92G3NJl-",
                id: "vid_7"
             },
             {
                 name: "Collection and prevention",
                 src: "https://www.youtube.com/embed/Qi_IcJGwadc?si=3huxfPjcCxgk_1fv",
                 id: "vid_7"
              },
