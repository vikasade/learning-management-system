...
<head>
    ...
    <title>Anesthesiology Playlist by Medicosis Perfectionalis</title>
    <style>
        .section .h1 {
	text-align: center;
	margin-top: 5rem;
...
<body>
    <section>
        <h1>Anesthesiology tutorial by Medicosis Perfectionalis</h1>
        <h2 class="title"></h2>
        <div class="container">
            <div id="video_player">
 ...
 // Ensure allVideos is defined and not empty
    let allVideos = [
       {
          name: "brief history",
          src: "https://www.youtube.com/embed/FuYkXRmBO3g?si=uR_QwQyvZNn0H6Oz" ,
            id: "vid_3"
        },
        {
            name: "Basics",
            src:"https://www.youtube.com/embed/ppap9UvbYBQ?si=JrV341zES89u5aym" ,
            id: "vid_4"
         },
       
         {
            name: "General Anesthesiology",
            src: "https://www.youtube.com/embed/1HJuIne-BKg?si=JKlTC5SgDecTDcWB"  ,
            id: "vid_6"
         },
         {
            name: "PharmacoKinetics",
            src:"https://www.youtube.com/embed/qvU3Ma_R9JE?si=PgkSoAeOn0aOBI11"  ,
            id: "vid_7"
         },
         {
            name: "Pharmo Dynamics ",
            src: "https://www.youtube.com/embed/e2pM930x9xw?si=6nJblZMYAXec9na1" ,
            id: "vid_8"
         },
         {
            name: "Airway Management",
            src: "https://www.youtube.com/embed/BS0v3-Aa_hM?si=B11r_lVWmcXtWLNT",
            id: "vid_9"
         },
         {
            name: "Regional Anesthesia",
            src: "https://www.youtube.com/embed/cpZuHAZj3gM?si=nV5VsbUFavKfj7kD",
            id: "vid_10"
         },
         {
            name: "Limb Block",
            src: "https://www.youtube.com/embed/RENSJNKYvyw?si=loaQn9SeNzoe6ODH" ,
            id: "vid_11"
         },
         {
            name: "Local Anasthesia",
            src: "https://www.youtube.com/embed/iRsL9D7AAs8?si=4MPsQn10XjfHGJlO",
            id: "vid_12"
         },
         {
             name: "Anastheology Review",
             src: "https://www.youtube.com/embed/ZYSbzPjwhWE?si=BkKlVSKrSTZdD8mt",
             id: "vid_12"
          },
          {
              name: "Cushing Reflex",
              src: "https://www.youtube.com/embed/zFyVG5flJPQ?si=OmeEzElF038BcpbS",
              id: "vid_12"
           },
