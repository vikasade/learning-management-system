<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" import="java.sql.*"%>
    ...
    <body>
        ...
        <%
		if(session.getAttribute("faculty") == null)									// check if admin is already student in to the system
		{
			response.sendRedirect("faculty_login.jsp");								// if not logged in, take student to login page
		}
%>
                                                ...
                                                <nav>
                                                    <ul id="navigation">
                                                        ...
                                                        <li><a href="#">Classroom</a>
                                                            <ul class="submenu">
                                                                <li><a href="faculty_videolectures.jsp">Video Lectures</a></li>
                                                                <li><a href="faculty_studymaterial.jsp">Study Materials</a></li>
